...
issue](https://github.com/cisagov/action-blacken-python2/issues) in this
...
request](https://github.com/cisagov/action-blacken-python2/pulls), you will
...
```console
cd action-blacken-python2
pyenv virtualenv <python_version_to_use> action-blacken-python2
pyenv local action-blacken-python2
